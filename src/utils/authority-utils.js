...
const JWTDomain = 'talbrain.com';

function getJWT() {
  return Cookie.get(JWTKey, { domain: JWTDomain });
}

function setJWT(jwt) {
  return Cookie.set(JWTKey, jwt, { domain: JWTDomain });
}

function removeJWT() {
  return Cookie.remove(JWTKey, { domain: JWTDomain });
}
...
export { getJWT, setJWT, removeJWT, getToken, setToken, removeToken, filterMenu, hasAuthority }
